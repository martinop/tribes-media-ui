			...
			<div className="tribes-audio-player sm:px-4">
				<div className="flex justify-between items-center flex-1 h-full px-2 sm:px-0">
					...
					<div className="flex pl-2 sm:p-0">
						<span className="self-end text-white text-xs sm:text-sm mr-2 sm:mr-4" ref={progressTextRef} />
						<div>
							{paused ? (
								<svg onClick={onPressPlay} className="opacity-75 hover:opacity-50 cursor-pointer h-8 w-8 sm:h-10 sm:w-10" version="1.1" xmlns="http://www.w3.org/2000/svg" width="inherit" height="inherit" fill="white" viewBox="0 0 100 100">
								...
								<svg onClick={onPressPause} className="opacity-75 hover:opacity-50 cursor-pointer h-8 w-8 sm:h-10 sm:w-10" version="1.1" xmlns="http://www.w3.org/2000/svg" width="inherit" height="inherit" fill="white" viewBox="0 0 100 100">
									<path d="M50,0C22.39,0,0,22.39,0,50c0,27.61,22.39,50,50,50c27.61,0,50-22.39,50-50C100,22.39,77.61,0,50,0z
						...
						<div className="ml-3 sm:ml-6">
							<svg onClick={_onClose} className="opacity-75 hover:opacity-50 cursor-pointer h-8 w-8 sm:h-10 sm:w-10" clssversion="1.1" xmlns="http://www.w3.org/2000/svg" width="40px" height="40px" fill="white" viewBox="0 0 100 100">
								<path d="M50,0C22.39,0,0,22.39,0,50c0,27.61,22.39,50,50,50c27.61,0,50-22.39,50-50C100,22.39,77.61,0,50,0z
