...
function EditSubModal(props) {
	...
	const showUpdateSection = !showForm && !successMessage && planSelected;
	const showAllPlans = !showUpdateSection && !showForm;
			...
			<StripeProvider apiKey={apiKey}>
				<>
					...
					{successMessage && !errorMessage && !showForm && (
						<div className="bg-success w-full text-white inline-flex items-center py-2 px-4 mb-10">
							<div>
								<svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
									...
									<path d="M16.5074 11.0705C17.0654 11.0705 17.5178 10.6182 17.5178 10.0602C17.5178 9.50215 17.0654 9.0498 16.5074 9.0498C15.9494 9.0498 15.4971 9.50215 15.4971 10.0602C15.4971 10.6182 15.9494 11.0705 16.5074 11.0705Z" fill="white"/>
									<path d="M8.49277 11.0705C9.05077 11.0705 9.50312 10.6182 9.50312 10.0602C9.50312 9.50215 9.05077 9.0498 8.49277 9.0498C7.93477 9.0498 7.48242 9.50215 7.48242 10.0602C7.48242 10.6182 7.93477 11.0705 8.49277 11.0705Z" fill="white"/>
									<path d="M18.2546 12.5587C18.0852 12.4231 17.848 12.4231 17.6786 12.5587C17.6108 12.6141 16.4434 13.5598 15.7842 14.9213C14.7677 14.413 13.6434 14.1451 12.5006 14.1451C10.1225 14.1451 7.94167 15.2632 6.51855 17.21C6.36762 17.4164 6.41382 17.7059 6.6202 17.8569C6.70337 17.9185 6.79886 17.9462 6.89127 17.9462C7.03297 17.9462 7.17466 17.8815 7.26399 17.7552C8.51153 16.0487 10.4213 15.0692 12.5006 15.0692C13.5325 15.0692 14.5459 15.3217 15.4608 15.7961C15.3838 16.0918 15.3375 16.3968 15.3375 16.711C15.3375 18.1618 16.5173 19.3416 17.9682 19.3416C19.419 19.3416 20.5988 18.1618 20.5988 16.711C20.5988 14.45 18.3501 12.6357 18.2546 12.5587ZM17.9682 18.4144C17.0287 18.4144 16.2616 17.6505 16.2616 16.7079C16.2616 15.3248 17.4168 14.0619 17.9682 13.5382C18.5195 14.0619 19.6747 15.3248 19.6747 16.7079C19.6747 17.6505 18.9077 18.4144 17.9682 18.4144Z" fill="white"/>
								</svg>
							</div>
							<p className="ml-2 my-auto leading-tight">{successMessage}</p>
						</div>
					)}
					{errorMessage && !successMessage && !showForm && (
						<div className="bg-error w-full text-white inline-flex items-center py-2 px-4 mb-10">
							<div>
								<svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
									<path d="M12.5 25C5.60621 25 0 19.3938 0 12.5C0 5.60621 5.60621 0 12.5 0C19.3938 0 25 5.60929 25 12.5C25 19.3907 19.3938 25 12.5 25ZM12.5 0.924101C6.11755 0.924101 0.924101 6.11755 0.924101 12.5C0.924101 18.8825 6.11755 24.0759 12.5 24.0759C18.8825 24.0759 24.0759 18.8825 24.0759 12.5C24.0759 6.11755 18.8825 0.924101 12.5 0.924101Z" fill="white"/>
									<path d="M7.56775 14.8718C5.40536 14.8718 3.64648 13.113 3.64648 10.9506C3.64648 8.78817 5.40536 7.0293 7.56775 7.0293C9.73015 7.0293 11.489 8.78817 11.489 10.9506C11.489 13.113 9.73015 14.8718 7.56775 14.8718ZM7.56775 7.9534C5.91669 7.9534 4.57058 9.29642 4.57058 10.9506C4.57058 12.6016 5.91361 13.9477 7.56775 13.9477C9.21881 13.9477 10.5649 12.6047 10.5649 10.9506C10.5618 9.2995 9.21881 7.9534 7.56775 7.9534Z" fill="white"/>
									<path d="M7.56914 11.7457C7.13173 11.7457 6.77441 11.3884 6.77441 10.951C6.77441 10.5136 7.13173 10.1562 7.56914 10.1562C8.00655 10.1562 8.36387 10.5136 8.36387 10.951C8.36387 11.3884 8.00655 11.7457 7.56914 11.7457Z" fill="white"/>
									<path d="M17.431 14.8718C15.2686 14.8718 13.5098 13.113 13.5098 10.9506C13.5098 8.78817 15.2686 7.0293 17.431 7.0293C19.5934 7.0293 21.3523 8.78817 21.3523 10.9506C21.3523 13.113 19.5934 14.8718 17.431 14.8718ZM17.431 7.9534C15.78 7.9534 14.4339 9.29642 14.4339 10.9506C14.4339 12.6016 15.7769 13.9477 17.431 13.9477C19.0852 13.9477 20.4282 12.6047 20.4282 10.9506C20.4282 9.2995 19.0852 7.9534 17.431 7.9534Z" fill="white"/>
									<path d="M17.4324 11.7457C16.995 11.7457 16.6377 11.3884 16.6377 10.951C16.6377 10.5136 16.995 10.1562 17.4324 10.1562C17.8698 10.1562 18.2271 10.5136 18.2271 10.951C18.2271 11.3884 17.8729 11.7457 17.4324 11.7457Z" fill="white"/>
									<path d="M8.90192 19.5012C8.82491 19.5012 8.74482 19.4827 8.67397 19.4395C8.45527 19.3133 8.37518 19.0329 8.50147 18.8112C8.58156 18.6725 10.5068 15.4043 16.227 16.3284C16.4795 16.3685 16.649 16.6056 16.6089 16.8582C16.5689 17.1108 16.3317 17.2833 16.0791 17.2402C11.0273 16.427 9.37013 19.1531 9.30236 19.2701C9.21611 19.418 9.06209 19.5012 8.90192 19.5012Z" fill="white"/>
								</svg>
							</div>
							<p className="ml-2 my-auto leading-tight">{errorMessage}</p>
						</div>
					)}
					{showAllPlans && (
						<PlansBox
